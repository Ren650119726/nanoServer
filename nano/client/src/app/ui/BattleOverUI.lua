local BattleOverUI = class("BattleOverUI", cc.load("mvc").ViewBase)
...
BattleOverUI.RESOURCE_FILENAME = "layout/game_end.csb"
BattleOverUI.RESOURCE_BINDING = {
...
function BattleOverUI:onBack(sender)
...
function BattleOverUI:onShare(sender)
    gameAssistant.playCloseUISound()
    local fileName = "CaptureScreen.png"
    cc.utils:captureScreen(afterCaptured, fileName)
end

function BattleOverUI:onCreate(title, rule, stats)
...
function BattleOverUI:registEvent()
